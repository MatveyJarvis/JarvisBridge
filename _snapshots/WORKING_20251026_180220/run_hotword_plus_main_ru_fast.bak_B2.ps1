# Jarvis Launcher — run_hotword_plus_main_ru_fast.ps1 (B1)
# — Автоприветствие при старте
# — Голосовая пауза: «Стоп Джарвис / Пауза Джарвис» → пауза до «Привет Джарвис»
